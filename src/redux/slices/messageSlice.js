...
export const createMessage = createAsyncThunk('messages/create', async (message, thunkAPI) => {
	try {
		let config = {
			headers: {
...
export const getMessagesNew = createAsyncThunk('messages/number', async (thunkAPI) => {
	try {
...
export const getMessages = createAsyncThunk('messages/get', async (thunkAPI) => {
	try {
		if (localStorage.getItem('userToken')) {
			let config = {
				headers: {
