...
export const getProducts = createAsyncThunk('products/getProducts', async (categoryid = null, thunkAPI) => {
...
export const getCheckProducts = createAsyncThunk('products/getCheckProducts', async (productsNumber = 6, thunkAPI) => {
	const { rejectWithValue } = thunkAPI;
