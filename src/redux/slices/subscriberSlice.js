...
export const createSubscriber = createAsyncThunk('subscribers/create', async (email, thunkAPI) => {
	try {
		let config = {
			headers: {
...
export const getSubscribers = createAsyncThunk('subscribers/get', async (_, thunkAPI) => {
	try {
