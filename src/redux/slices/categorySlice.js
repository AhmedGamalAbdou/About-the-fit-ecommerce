...
export const createCategory = createAsyncThunk('categories/create', async (category, thunkAPI) => {
	try {
		...
		if (userToken) {
			...
			const { data } = await axios.post('/api/catalogs', { ...category }, config);
...
export const deleteCategory = createAsyncThunk('categories/delete', async (id, thunkAPI) => {
	try {
		if (localStorage.getItem('userToken')) {
			...
			const { data } = await axios.post('/api/catalogs/delete', { id }, config);
...
export const getCategoryById = createAsyncThunk('categories/getCategoryById', async (id, thunkAPI) => {
